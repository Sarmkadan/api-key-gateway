...
/// <summary>
/// Provides System.Text.Json serialization extensions for <see cref="AdminController"/>.
/// </summary>
public static class AdminControllerJsonExtensions
{
    ...
    /// <summary>
    /// Serializes the <see cref="AdminController"/> instance to a JSON string.
    /// </summary>
    ...
    public static string ToJson(this AdminController value, bool indented = false)
    {
    ...
    public static AdminController? FromJson(string json)
    {
        ...
        return JsonSerializer.Deserialize<AdminController>(json, _jsonOptions);
    }
    ...
    public static bool TryFromJson(string json, out AdminController? value)
    {
        ...
        try
        {
            value = JsonSerializer.Deserialize<AdminController>(json, _jsonOptions);
            return true;
        }
        catch (JsonException)
        {
