...
/// <summary>
/// Provides extension methods for serializing and deserializing <see cref="ConfigurationException"/> to/from JSON.
/// </summary>
public static class ConfigurationExceptionJsonExtensions
{
    ...
    /// <summary>
    /// Serializes the <see cref="ConfigurationException"/> to a JSON string.
    /// </summary>
