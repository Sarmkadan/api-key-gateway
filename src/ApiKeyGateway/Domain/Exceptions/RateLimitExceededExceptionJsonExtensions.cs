...
/// <summary>
/// Provides JSON serialization helpers for <see cref="RateLimitExceededException"/>.
/// </summary>
public static class RateLimitExceededExceptionJsonExtensions
{
    ...
    /// <summary>
    /// Serializes a <see cref="RateLimitExceededException"/> to a JSON string.
    /// </summary>
    ...
    /// <summary>
    /// Deserializes a JSON string to a <see cref="RateLimitExceededException"/>.
    /// </summary>
    ...
    /// <summary>
    /// Attempts to deserialize a JSON string to a <see cref="RateLimitExceededException"/>.
    /// </summary>
    /// <param name="json">The JSON string to deserialize.</param>
