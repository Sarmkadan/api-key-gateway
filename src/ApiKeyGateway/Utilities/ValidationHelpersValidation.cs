...
public static class ValidationHelpersValidation
{
	...
	/// <returns>List of validation problems (empty if valid)</returns>
	/// <exception cref="ArgumentNullException">Thrown when <paramref name="keyValue"/> is null</exception>
	...
	public static IReadOnlyList<string> ValidateGuid(string value)
	{
		...
		{
			return new[] { "GUID cannot be null or whitespace" }.AsReadOnly();
		}
	...
	/// <returns>True if valid, false otherwise</returns>
	/// <exception cref="ArgumentNullException">Thrown when <paramref name="keyValue"/> is null</exception>
	public static bool IsValidApiKey(string keyValue) => ValidateApiKey(keyValue).Count == 0;
	...
	/// <returns>True if valid, false otherwise</returns>
	/// <exception cref="ArgumentNullException">Thrown when <paramref name="ipAddress"/> is null</exception>
	public static bool IsValidIpAddress(string ipAddress) => ValidateIpAddress(ipAddress).Count == 0;
	...
	/// <returns>True if valid, false otherwise</returns>
	/// <exception cref="ArgumentNullException">Thrown when <paramref name="value"/> is null</exception>
	public static bool IsValidGuid(string value) => ValidateGuid(value).Count == 0;
	...
	/// <returns>True if valid, false otherwise</returns>
	/// <exception cref="ArgumentNullException">Thrown when <paramref name="url"/> is null</exception>
	public static bool IsValidUrl(string url) => ValidateUrl(url).Count == 0;
	...
	/// <returns>True if valid, false otherwise</returns>
	/// <exception cref="ArgumentOutOfRangeException">Thrown when <paramref name="maxLength"/> is less than 1</exception>
	public static bool IsValidSanitizeInput(string input, int maxLength = 1000) => ValidateSanitizeInput(input, maxLength).Count == 0;
