...
/// <summary>
/// Provides JSON serialization helpers for <see cref="IpWhitelistTests"/> instances.
/// </summary>
public static class IpWhitelistTestsJsonExtensions
{
    ...
    /// <summary>
    /// Serializes the <see cref="IpWhitelistTests"/> instance to a JSON string.
    /// </summary>
    ...
    /// <summary>
    /// Deserializes a JSON string to an <see cref="IpWhitelistTests"/> instance.
    /// </summary>
    ...
    /// <summary>
    /// Attempts to deserialize a JSON string to an <see cref="IpWhitelistTests"/> instance.
    /// </summary>
    /// <param name="json">The JSON string to deserialize.</param>
