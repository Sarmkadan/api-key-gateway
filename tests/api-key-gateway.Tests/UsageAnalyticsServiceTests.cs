...
/// <summary>
/// Contains unit tests for the <see cref="UsageAnalyticsService"/> class.
/// Tests verify that usage analytics calculations and aggregations work correctly
/// for various scenarios including empty data, mixed success/failure records,
/// endpoint popularity ranking, and time-based trends.
/// </summary>
public class UsageAnalyticsServiceTests
{
	/// <summary>
	/// Mock service for tracking usage records.
	/// </summary>
	...
	/// <param name="recordedAt">Timestamp when the record was created.</param>
