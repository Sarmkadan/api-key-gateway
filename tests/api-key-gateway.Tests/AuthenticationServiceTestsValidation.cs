...
{
    /// <summary>
    /// Provides validation helpers for <see cref="AuthenticationServiceTests"/> test class.
    /// </summary>
    public static class AuthenticationServiceTestsValidation
    {
        /// <summary>
        ...
        public static IReadOnlyList<string> Validate(this AuthenticationServiceTests value)
        {
            ...
            var testMethods = value.GetType()
                ...
                .Where(m => m.Name.StartsWith("AuthenticateAsync") ||
                            m.Name.StartsWith("ValidateIpAsync") ||
                            m.Name.StartsWith("LogAuthenticationAttemptAsync"));
        ...
        /// <exception cref="ArgumentNullException">Thrown when <paramref name="value"/> is null.</exception>
        public static bool IsValid(this AuthenticationServiceTests value)
        {
            ArgumentNullException.ThrowIfNull(value);
        ...
        public static void EnsureValid(this AuthenticationServiceTests value)
        {
            ArgumentNullException.ThrowIfNull(value);
