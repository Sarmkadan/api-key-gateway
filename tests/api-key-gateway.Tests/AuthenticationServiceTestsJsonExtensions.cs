...
/// <summary>
/// Provides JSON serialization extensions for <see cref="AuthenticationServiceTests"/> to facilitate
...
public static class AuthenticationServiceTestsJsonExtensions
{
    ...
    /// <summary>
    /// Serializes the <see cref="AuthenticationServiceTests"/> instance to a JSON string.
    /// </summary>
    ...
    public static AuthenticationServiceTests? FromJson(string json)
    {
        ...
        return JsonSerializer.Deserialize<AuthenticationServiceTests>(json, _jsonSerializerOptions);
    }
    ...
    public static bool TryFromJson(string json, out AuthenticationServiceTests? value)
    {
        ...
        try
        {
            value = JsonSerializer.Deserialize<AuthenticationServiceTests>(json, _jsonSerializerOptions);
            return true;
        }
        catch (JsonException)
        {
